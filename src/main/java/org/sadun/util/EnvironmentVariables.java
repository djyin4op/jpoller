...
public class EnvironmentVariables {
	...
	/**
	 * A {@link NameTransformer NameTransformer}which
	...
	private static class IdenticalNameTransformer implements NameTransformer {
		...
		/**
		 * @see NameTransformer#transform(String)
		 */
		public String transform(String name) {
			return name;
		}
	 ...
	 * as obtained by
	 * {@link #getEnvProperty(String) getEnvProperty()}
	 * 
	 * @return the set of property names derived by the environment variables
	 */
	...
	/**
	 * Add properties obtained by {@link #getEnvProperty(String)
